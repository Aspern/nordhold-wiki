...
const banners: Banner[] = [
  {
    ...
    effectSummary: { en: "Strengthens arc effects.", de: "Verstärkt Arkaneffekte." },
  ...
  },
  {
    ...
    effectSummary: { en: "Improves reliable output.", de: "Verbessert verlässliche Wirkung." },
  ...
  },
  {
    ...
    effectSummary: { en: "Changes one tactical rule.", de: "Verändert eine taktische Regel." },
  ...
  },
  {
    ...
    effectSummary: { en: "Combines two tower traits.", de: "Vereint zwei Turmeigenschaften." },
